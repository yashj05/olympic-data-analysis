...
st.sidebar.image('https://clipground.com/images/olympics-logo-2.jpg')
...
if user_menu == 'Medal Tally':
    ...
    if selected_years != 'Overall' and selected_country != 'Overall':
        st.title(selected_country + " performance in " + str(selected_years) + " year")
...
if user_menu == 'Athlete-wise Analysis':
    ...
    famous_sport = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics', 'Swimming', 'Badminton', 'Sailing',
                    ...
                    'Table Tennis',
                    'Baseball', 'Gymnastics', 'Rhythmic Gymnastics', 'Rugby Sevens', 'Beach Volleyball',
